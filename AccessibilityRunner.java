...
public class AccessibilityRunner {
    ...
    public void run() {
        JFrame frame = new JFrame("Accessibility Runner");
...
public class Accessibility extends JPanel implements MouseListener, KeyListener {
    ...
    public void medicalPageContent(Graphics g) {
        /* Assume this method is complete. */
    }
    ...
    public void mouseClicked(MouseEvent evt) {
        ...
        // Check if "brighter" rectangle is clicked
        if ((xMouse >= 10 && xMouse <= 110) && (yMouse >= 10 && yMouse <= 30)) {
            if (colorParameterVar <= 252) {
                colorParameterVar += 3;
            } else {
        ...
        // Check if "darker" rectangle is clicked
        else if ((xMouse >= 115 && xMouse <= 215) && (yMouse >= 10 && yMouse <= 30)) {
            if (colorParameterVar >= 37) {
                colorParameterVar -= 3;
            } else {
